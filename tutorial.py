...
from attack_water import start_water  # Import the Attack Water game function
    ...
    while running:
        ...
        if door_open and player_rect.colliderect(door_rect) and not next_game_triggered:
            ...
            if chosen_power == "fire":
                start_game2()  # Call Abyss game function
            elif chosen_power == "water":
                start_water()  # Call Attack Water game function
            break
